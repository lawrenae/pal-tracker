...
public class TimeEntry {
    ...
    public TimeEntry(long id, long projectId, long userId, String when, int hours) {
        this.id = id;
        this.projectId = projectId;
        this.userId = userId;
        this.date = "today".equals(when) ? LocalDate.now() : LocalDate.now().minusDays(1);
        this.hours = hours;
    }

    public TimeEntry(long projectId, long userId, String when, int hours) {
        this.projectId = projectId;
        this.userId = userId;
        this.date = "today".equals(when) ? LocalDate.now() : LocalDate.now().minusDays(1);
        this.hours = hours;
